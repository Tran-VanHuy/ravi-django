...
class Recruitment(models.Model):
    ...
    image = image = models.FileField(upload_to="images", unique=True, verbose_name="image")
...
class Apply(models.Model):
    ...
    resume_cv = models.FileField(upload_to="cv", unique=True, verbose_name="Resume/CV")
